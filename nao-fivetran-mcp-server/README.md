...
A [Model Context Protocol](https://modelcontextprotocol.io) server designed by [nao](https://getnao.io) to interact with Fivetran. It lets AI assistants manage your Fivetran pipelines — connectors, destinations, groups, and users.
