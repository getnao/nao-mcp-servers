...
export const tools: Record<string, Tool> = {
    ...
    'execute-question': {
        ...
        handler: async ({ questionId, parameters }: any) => {
            const response = await axiosInstance.post(`/api/card/${questionId}/query`, {
    ...
    'get-database-metadata': {
        ...
        handler: async ({ databaseId }: any) => {
            const response = await axiosInstance.get(`/api/database/${databaseId}/metadata`);
            return {
                content: [{
                    type: 'text',
                    text: JSON.stringify(response.data, null, 2)
    ...
    'get-database-schemas': {
        ...
        handler: async ({ databaseId }: any) => {
            const response = await axiosInstance.get(`/api/database/${databaseId}/schemas`);
            return {
                content: [{
                    type: 'text',
                    text: JSON.stringify(response.data, null, 2)
    ...
    'get-table-metadata': {
        ...
        handler: async ({ tableId }: any) => {
            const response = await axiosInstance.get(`/api/table/${tableId}/query_metadata`);
            return {
                content: [{
                    type: 'text',
                    text: JSON.stringify(response.data, null, 2)
    ...
    'get-collection-items': {
        ...
        handler: async ({ collectionId }: any) => {
            const response = await axiosInstance.get(`/api/collection/${collectionId}/items`);
            return {
                content: [{
                    type: 'text',
                    text: JSON.stringify(response.data, null, 2)
